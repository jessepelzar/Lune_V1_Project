...
void MD5Init001 (MD5_CTX *context)                                       /* context */
{
 ...
 * context.
 */
void MD5Update001 (MD5_CTX *context, unsigned char *input,unsigned int inputLen) /* length of input block */
{
 ...
 */
void MD5Final001 (unsigned char digest[16], MD5_CTX *context)
{
